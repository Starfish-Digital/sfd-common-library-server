...
const getInstitutionConfig = async (request, response) => {
  await Controller.handleRequest(request, response, service.getInstitutionConfig);
};

const getInstitutionConfigByAuthorizationUrl = async (request, response) => {
  await Controller.handleRequest(request, response, service.getInstitutionConfigByAuthorizationUrl);
};
